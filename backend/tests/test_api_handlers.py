...
import app.api.v1.students
import app.api.v1.tags
import app.api.v1.notifications
import app.api.v1.resources
import app.api.v1.lesson_plans
import app.api.v1.users
import app.api.v1.dropdown_options
import app.api.v1.portfolios
import app.api.v1.lesson_templates
import app.api.v1.reports
...
class TestNotificationEndpoints:
    ...
    async def test_list_notifications_with_filters(self, client, auth_headers, test_user, db_session):
        await self._create_notification(db_session, test_user.id)
...
class TestUserEndpoints:
    ...
    async def test_update_user_duplicate_username(self, client, auth_headers, test_user, db_session):
        other_user = User(
