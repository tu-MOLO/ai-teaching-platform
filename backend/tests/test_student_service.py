...
class TestComputeProgressFromPortfolios:
    ...
    def test_single_portfolio(self):
        portfolio = _make_portfolio(cognitive=80, skill=70, creativity=90, cooperation=60, attention=50)
    ...
    def test_partial_scores_some_none(self):
        p1 = _make_portfolio(cognitive=80, skill=None, creativity=90, cooperation=None, attention=50)
        p2 = _make_portfolio(cognitive=60, skill=80, creativity=None, cooperation=90, attention=None)
        result = StudentService._compute_progress_from_portfolios([p1, p2])
        ...
        expected_avg = (expected_cognitive + expected_skill + expected_creativity + expected_cooperation + expected_attention) / 5
    ...
    def test_all_100s(self):
        portfolio = _make_portfolio(cognitive=100, skill=100, creativity=100, cooperation=100, attention=100)
        result = StudentService._compute_progress_from_portfolios([portfolio])
        assert result == 100
    ...
    def test_all_none_scores_returns_zero(self):
        portfolio = _make_portfolio(cognitive=None, skill=None, creativity=None, cooperation=None, attention=None)
        result = StudentService._compute_progress_from_portfolios([portfolio])
        assert result == 0
