...
class TestNotificationAPI:
    ...
    @pytest.mark.asyncio
    async def test_list_notifications_pagination(self, client, test_user, auth_headers, seed_notifications):
    ...
    @pytest.mark.asyncio
    async def test_list_notifications_filter_by_type(self, client, test_user, auth_headers, seed_notifications):
    ...
    @pytest.mark.asyncio
    async def test_list_notifications_filter_by_read(self, client, test_user, auth_headers, seed_notifications):
    ...
    @pytest.mark.asyncio
    async def test_get_notification_stats(self, client, test_user, auth_headers, seed_notifications):
    ...
    @pytest.mark.asyncio
    async def test_get_notification_detail(self, client, test_user, auth_headers, seed_notifications):
    ...
    @pytest.mark.asyncio
    async def test_mark_notification_as_read(self, client, test_user, auth_headers, seed_notifications):
    ...
    @pytest.mark.asyncio
    async def test_mark_batch_as_read_without_ids(self, client, test_user, auth_headers, seed_notifications):
