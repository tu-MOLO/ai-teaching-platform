...
class AuditLog(BaseModel):
    ...
    resource_type: Mapped[str] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="资源类型（如：student, course, user）"
    )
...
class AuditLogBuilder:
    ...
    def changes(self, old_values: Optional[Dict] = None, new_values: Optional[Dict] = None, 
                changed_fields: Optional[list] = None) -> "AuditLogBuilder":
        """设置变更内容"""
        import json
        if old_values:
    ...
    def request_info(self, ip_address: Optional[str] = None, user_agent: Optional[str] = None,
                     path: Optional[str] = None, method: Optional[str] = None) -> "AuditLogBuilder":
        """设置请求信息"""
    ...
    def result(self, success: bool = True, error_message: Optional[str] = None,
               execution_time: Optional[int] = None) -> "AuditLogBuilder":
        """设置执行结果"""
