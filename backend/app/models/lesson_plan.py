...
class LessonPlan(BaseModel):
    ...
    teaching_content: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="教学内容"
    )

    teaching_methods: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="教学方法"
    )

    teaching_process: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="教学过程"
    )
