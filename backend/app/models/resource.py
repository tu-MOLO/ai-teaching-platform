...
resource_tag_association = Table(
    ...
    Base.metadata,
    Column(
        "resource_id", String(36), ForeignKey("resources.id", ondelete="CASCADE"), primary_key=True
    ),
...
class Resource(BaseModel):
    ...
    description: Mapped[str] = mapped_column(Text, nullable=True, comment="资源描述")
    ...
    file_type: Mapped[str] = mapped_column(
        String(50), nullable=False, index=True, comment="文件类型"
    )
