...
class Student(BaseModel):
    ...
    name: Mapped[str] = mapped_column(String(100), nullable=False, index=True, comment="学生姓名")
    ...
    class_name: Mapped[str] = mapped_column(String(50), nullable=False, index=True, comment="班级")
    ...
    parent_contact: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, comment="家长联系方式"
    )

    is_active: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=True, comment="是否在读"
    )
    ...
    courses: Mapped[List["Course"]] = relationship(
        ...
        primaryjoin="and_(Student.id == course_student.c.student_id, Course.is_deleted == False)",  # noqa
    ...
    # 复合索引
    __table_args__ = (Index("ix_students_grade_class", "grade", "class_name"),)
