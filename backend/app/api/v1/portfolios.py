...
async def create_portfolio(
    portfolio_in: PortfolioCreate, db: DBSession, user_id: CurrentUser
...
@router.get(
    "/{portfolio_id}", response_model=DataResponse[PortfolioSchema], summary="获取成长档案详情"
)
async def get_portfolio(
    portfolio_id: str, db: DBSession, user_id: CurrentUser
) -> DataResponse[PortfolioSchema]:
    """
    根据ID获取成长档案详情
    """
...
async def update_portfolio(
    portfolio_id: str, portfolio_in: PortfolioUpdate, db: DBSession, user_id: CurrentUser
) -> DataResponse[PortfolioSchema]:
    """
    更新成长档案信息
    """
...
async def delete_portfolio(portfolio_id: str, db: DBSession, user_id: CurrentUser) -> None:
    """
    删除成长档案（软删除）
    """
