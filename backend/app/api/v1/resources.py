...
async def create_resource(
    ...
    try:
        ...
        raise InternalException("创建资源失败")
...
async def get_resources(
    ...
    try:
        ...
        raise InternalException(f"获取资源列表失败: {str(e)}")
...
async def get_resource(
    ...
    try:
        ...
        raise InternalException("获取资源失败")
...
async def update_resource(
    ...
    try:
        ...
        raise InternalException("更新资源失败")
...
async def delete_resource(
    ...
    try:
        ...
        raise InternalException("删除资源失败")
