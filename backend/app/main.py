...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # 自动初始化下拉选项（确保下拉不为空）
        await _init_dropdown_options_if_empty()
...
async def _init_dropdown_options_if_empty() -> None:
    """如果下拉选项表为空，自动初始化默认选项。"""
    ...
    DEFAULTS: dict[str, list[tuple[str, str]]] = {
        ...
        "course_grade": [
            ("培智一年级", "培智一年级"), ("培智二年级", "培智二年级"),
            ("培智三年级", "培智三年级"), ("培智四年级", "培智四年级"),
            ("培智五年级", "培智五年级"), ("培智六年级", "培智六年级"),
        ],
        "course_status": [("进行中", "active"), ("已结束", "inactive"), ("草稿", "draft")],
        "lesson_plan_subject": [
            ("语文", "语文"), ("数学", "数学"), ("美术", "美术"),
            ("音乐", "音乐"), ("体育", "体育"), ("生活适应", "生活适应"),
        ],
        "lesson_plan_grade": [
            ("培智一年级", "培智一年级"), ("培智二年级", "培智二年级"),
            ("培智三年级", "培智三年级"), ("培智四年级", "培智四年级"),
        ...
        "portfolio_record_type": [
            ("作品", "work"), ("评价", "evaluation"),
            ("观察记录", "observation"), ("里程碑", "milestone"),
        ],
        "resource_tag": [
            ("教案", "教案"), ("视频", "视频"), ("图片", "图片"),
            ("文档", "文档"), ("模板", "模板"), ("培智教育", "培智教育"),
            ("生活技能", "生活技能"), ("认知训练", "认知训练"),
        ],
    }
        ...
        async with AsyncSessionLocal() as session:
            ...
            for group_key, items in DEFAULTS.items():
                existing = await DropdownOptionService.list_options(
                    session, group_key=group_key, active_only=False
                )
                ...
                for index, (label, value) in enumerate(items):
                    ...
                    created_count += 1
            if created_count:
                logger.info(f"Auto-initialized {created_count} dropdown options")
    except Exception as e:
        logger.warning(f"Failed to auto-initialize dropdown options: {e}")
