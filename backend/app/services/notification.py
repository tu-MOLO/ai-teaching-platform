...
class NotificationService:
    ...
    @staticmethod
    async def get(db: AsyncSession, notification_id: str, user_id: Optional[str] = None) -> Optional[Notification]:
        """
        获取通知
    ...
    @staticmethod
    async def mark_as_read(db: AsyncSession, notification_id: str, user_id: str) -> Optional[Notification]:
        """
        标记通知为已读
    ...
    @staticmethod
    async def mark_multiple_as_read(db: AsyncSession, user_id: str, notification_ids: List[str]) -> int:
        """
        批量标记通知为已读
    ...
    @staticmethod
    async def update(db: AsyncSession, notification_id: str, user_id: str, notification_in: NotificationUpdate) -> Optional[Notification]:
        """
        更新通知
