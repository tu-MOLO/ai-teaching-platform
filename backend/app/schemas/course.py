...
class CourseBase(BaseSchema):
    ...
    status: str = Field(default="active", description="课程状态: active-进行中, inactive-已结课, draft-草稿")
...
class CourseUpdate(BaseSchema):
    ...
    schedule: Optional[str] = Field(None, description="课程安排", max_length=500)
    description: Optional[str] = Field(None, description="课程描述")
    status: Optional[str] = Field(None, description="课程状态: active-进行中, inactive-已结课, draft-草稿")
